var fsrBaseURL = document.location.href.match(/\/licensing\/servicecenter\w*\//i);
var fsrRelativeURL = 'Assets/Scripts/foresee/';
var FSR = {
    'version': '6.4.0',
    'date': '1/12/2011',
    'enabled': true,
	'auto' : true,
	'encode' : false,
    'files': fsrBaseURL[0] + fsrRelativeURL,
 	'id': 'BkxgcZRxcFcN9EcId5wRtA==',
    'sites': [{
        name: 'VLSC',
		path: /\w+\.(com|org|edu|gov|net)/,
...
if(!this.trackerRunning()){this.cancelAlive();if(this.exclude()){this.v=0;return }}if(!P){fsr$dbug.log("Exit: Cookies are not enabled");
