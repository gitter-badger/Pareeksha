//Tag Version: Windows 1.2/05-29-08
var gTagVer = "Windows 1.2/05-29-08";
var gService = true;
var gTimeZone = -8;
function wtClearAllVariables()
{
    try
    {
        DCSext.win_hero="";
        DCSext.win_evttype="";
        DCSext.win_subhero="";
        DCSext.win_banner_pop="";
        DCSext.win_mid_tabs="";
        DCSext.win_vcp="";
        DCSext.win_fpcs="";
        DCSext.win_tpu="";
        DCSext.win_upnow_render="";
        DCSext.win_featdl_render="";
    }
    catch(ex) { }
}
function wtClearFiveVariables()
{
    try
    {
        DCSext.win_hero="";
...
function dcsSetVar(){
	...
	if(DCSext.win_evttype=="1"&&DCSext.win_hero!=""){
		wtClearFiveVariables();
	}
}
...
function dcsDownload(evt){
	...
	if (evt){
		...
		if(e){
			if (e.href&&e.hostname&&e.protocol&&(e.protocol.indexOf("http")!=-1)){
				dcsNavigation(e);
